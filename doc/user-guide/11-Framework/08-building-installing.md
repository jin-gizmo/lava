...
2.  Perform some pre-installation checks (e.g. verify permission to write
    to the payloads area in S3, verify schema compliance for DynamoDB table
    entries and event rule specifications, etc.).
