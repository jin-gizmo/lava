...
The conditional logic use any of the configuration information made available
when rendering the item, including the contents of the environment configuration
file.
