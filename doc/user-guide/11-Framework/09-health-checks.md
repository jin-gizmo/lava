...
The [lava-schema](#lava-schema-utility) utility is bundled with the lava job
framework and is used to verify schema compliance for the **built versions** of
the following deployable components:

*   lava job specifications

*   lava connection specifications

*   lava s3trigger specifications

*   lava [event rule specifications](#creating-amazon-eventbridge-rules).

The verification is done automatically as part of a pre-installation check.

The process can also be run manually like so:
