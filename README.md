...
<div align="center">
<img src="doc/img/lava-icons/svg/256/lava-icon-256-opaque.svg" alt="Lava Logo" width="120px" height="auto">
</div>
...
![GitHub Tag](https://img.shields.io/github/v/tag/jin-gizmo/lava?filter=v*&label=version)
[![Python versions](https://img.shields.io/pypi/pyversions/jinlava)](https://pypi.org/project/jinlava/)
[![GitHub Licence](https://img.shields.io/github/license/jin-gizmo/lava)](https://github.com/jin-gizmo/lava/blob/master/LICENCE.txt)
[![Code style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black)

---
<!-- toc-start min=2 max=2 style=linear -->
<!-- Generated by TOCmark v1.0.0 (https://github.com/jin-gizmo/tocmark) -->

[Genesis](#genesis) &bull;
[Installation&nbsp;and&nbsp;Usage](#installation-and-usage) &bull;
...
See also the [lava GUI](https://jin-gizmo.github.io/lava-gui).
