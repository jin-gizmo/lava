...
# Shell commands to be run after any other local custom boot scripts are run.

# EC2 only

# Look for a JSON user data structure containing a "shell" key.  The value of this
...
/usr/local/sbin/userdata-shell shell
